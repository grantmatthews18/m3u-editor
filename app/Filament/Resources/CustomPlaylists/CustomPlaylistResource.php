            ...
            Section::make('EPG Output')
                ...
                ->schema([
                    Toggle::make('dummy_epg')
                        ...
                        ->required()
                        ->disabled(fn (?CustomPlaylist $record): bool => $record?->usesRegexManagement() ?? false),
                    ...
                    \Filament\Forms\Components\Repeater::make('event_patterns')
                        ...
                        ->schema([
                            ...
                            TextInput::make('timezone')
                                ->label('Timezone')
                                ->placeholder('UTC')
                                ->helperText('Timezone for parsing times (e.g. America/New_York)'),
                            TextInput::make('default_length')
